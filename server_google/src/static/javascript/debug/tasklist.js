...
function Task(listKey, key, us_text, completed) {
  this.listKey_ = listKey;
  this.key_ = key;
  this.us_text_ = us_text;
...
Task.prototype.attach = function(container) {
  ...
  var descriptionCell = this.createElement_("td", tr, "us_text");
...
Task.prototype.saveEdit_ = function() {
  var changed = this.textBox_.value != this.us_text_;
  if (changed) {
    this.us_text_ = this.textBox_.value;
    this.resetDescriptionText_();
  }
  this.cleanUpEdit_();
  if (changed) {
...
Task.prototype.resetDescriptionText_ = function() {
  ...
  descriptionText.appendChild(document.createTextNode(this.us_text_));
...
Task.prototype.save = function() {
  var args = [
      ...
      "us_text=" + encodeURIComponent(this.us_text_)
  ];
  if (this.key_) {
